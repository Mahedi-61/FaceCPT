...
class FaceCPT_Decoder(nn.Module):
    ...
    def forward(self, image, caption):
        ...
        text = self.tokenizer(caption, padding='longest', truncation=True, 
                              max_length=40, return_tensors="pt").to(image.device) 
    ...
    def generate(self, image, sample=False, num_beams=3, max_length=45, 
...
if __name__ == "__main__":
    ve, vw = create_vit(vit="base", image_size=384)
    print(sum([p.numel() for p in ve.parameters() if p.requires_grad]))